...
public class LogUtil {
	...
	private final static Logger GATELOG = LoggerFactory.getLogger("INFO_LOG");
	private final static Logger GATELOG_ERROR = LoggerFactory.getLogger("ERR_LOG");
	private final static Logger GATELOG_MESSAGE = LoggerFactory.getLogger("MSG_LOG");

	final static String LOG_STRING_REQ_MSG_BEGIN = "============================== REQ MSG BEGIN ==============================";
	final static String LOG_STRING_REQ_MSG_END = "==============================  REQ MSG END  ==============================";
	final static String LOG_STRING_RSP_MSG_BEGIN = "============================== RSP MSG BEGIN ==============================";
	final static String LOG_STRING_RSP_MSG_END = "==============================  RSP MSG END  ==============================";
